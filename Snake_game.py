    ...
    def repaint(self):
        ...
        if snake.checkGameOver() == False:
            ...
            canvas.create_rectangle(snake.getSnakeX(0) * tilesize, snake.getSnakeY(0) * tilesize,
                                    ...
                                    snake.getSnakeY(0) * tilesize + tilesize, fill="red") 
            #body
...
canvas.configure(background="aqua")
canvas.pack()
